...
transform = transforms.Compose([
    ...
    transforms.CenterCrop(224),  # VGGNet expects 224x224 images
    transforms.ToTensor(),
...
# Model setup
model = torch.hub.load('pytorch/vision:v0.10.0', 'vgg16', pretrained=True)  # Load VGGNet
model.classifier = nn.Sequential(
    nn.Dropout(dropout_rate),
    nn.Linear(model.classifier[6].in_features, len(dataset.classes))  # Adjust for number of classes
)
